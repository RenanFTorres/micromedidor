...
char on_resp[] = "<!DOCTYPE HTML><html>\n"
                   "<head>\n"
                   "  <title>ESP-IDF Medidor de Consumo Server</title>\n"
                   ...
                   "        <h4><i class=\"fas fa-tint\"></i> HUMIDITY</h4><p><span class=\"reading\"></span> &percnt;</span></p>\n"
                   "      </div>\n"
                   "      <div class=\"card pressure\">\n"
                   "        <h4><i class=\"fas fa-angle-double-down\"></i> PRESSURE</h4><p><span class=\"reading\">hPa</span></p>\n"
                   "      </div>\n"
                   "    </div>\n"
                   "  </div>\n"
                   "</body>\n"
...
esp_err_t send_web_page(httpd_req_t *req)
{
    ...
    else
    {
        ...
        sprintf(response_data, on_resp, meu_valor);
