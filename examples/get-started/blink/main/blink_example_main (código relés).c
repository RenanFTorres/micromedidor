...
int sort()
{
    ...
    number = rand() % 4;   // Gera um número entre 0 e 19
    //for(i=1 ; i <= 10 ; i++)
    printf("Numero: %d\n", number);
    return number;
}
...
void app_main(void)
{
    ...
    while (1) {
        ...
        numero = sort();
        if (numero == 0 || numero == 6) {  // lâmpada amarela apaga e lâmpada verde acende
            gpio12_state = 0;
            gpio14_state = 1;
            gpio27_state = 0;
            gpio13_state = 1;
        ...
        if (numero == 1 || numero == 11) {  // lâmpada branca apaga e lâmpada azul acende
            gpio12_state = 1;
            gpio14_state = 1;
            gpio27_state = 0;
            gpio13_state = 1;
        ...
        if (numero != 5 && numero != 6 && numero != 10 && numero != 11 && numero != 12 && numero != 27) {
            gpio12_state = 0;
            gpio14_state = 0;
            gpio27_state = 0;
            gpio13_state = 1;
