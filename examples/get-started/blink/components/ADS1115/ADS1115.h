...
#define ADS1115_CFG_MS_MUX_OMASK          0x8FFF  // mask out (originalmente era 0x8F00)

// inline functions pass these defintions, so are shifted instead of an uint16 argument
#define ADS1115_CFG_MS_MUX_AIN0_AIN1 0x00    // default
#define ADS1115_CFG_MS_MUX_AIN0_AIN3 0x10 
#define ADS1115_CFG_MS_MUX_AIN1_AIN3 0x20  
#define ADS1115_CFG_MS_MUX_AIN2_AIN3 0x30  
#define ADS1115_CFG_MS_MUX_AIN0_GND  0x40  
#define ADS1115_CFG_MS_MUX_AIN1_GND  0x5000  
#define ADS1115_CFG_MS_MUX_AIN2_GND  0x60  
#define ADS1115_CFG_MS_MUX_AIN3_GND  0x70
...
#define ADS1115_CFG_LS_DR_860SPS          0xE0
//#define ADS1115_CFG_LS_DR_8SPS           0x00
//#define ADS1115_CFG_LS_DR_16SPS          0x20
//#define ADS1115_CFG_LS_DR_32SPS          0x40
//#define ADS1115_CFG_LS_DR_64SPS          0x60
//#define ADS1115_CFG_LS_DR_128SPS         0x80   // default
//#define ADS1115_CFG_LS_DR_250SPS         0xA0
//#define ADS1115_CFG_LS_DR_475SPS         0xC0
#//define ADS1115_CFG_LS_DR_860SPS         0xE0
...
typedef struct {         // Cria uma struct (são Registros usados para agrupar variáveis de uma mesma entidade)
   uint16_t reg_cfg;     // Registrador de configuração com 16 bits
   uint8_t rw_buff[2];   // 
   uint8_t dev_addr;     //
} ads1115_t;             // Nome da struct criada
...
//int16_t ADS1115_get_raw(ads1115_t *cfg); // get voltage in bits
//double ADS1115_get_voltage(ads1115_t *cfg); // get voltage in volts
...
static inline esp_err_t ADS1115_request_single_ended_AIN0() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN0_GND); };
static inline esp_err_t ADS1115_request_single_ended_AIN1() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN1_GND); };
static inline esp_err_t ADS1115_request_single_ended_AIN2() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN2_GND); };
static inline esp_err_t ADS1115_request_single_ended_AIN3() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN3_GND); };

static inline esp_err_t ADS1115_request_continuous_ended_AIN1() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN1_GND); };

static inline esp_err_t ADS1115_request_diff_AIN0_AIN1() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN0_AIN1); };
static inline esp_err_t ADS1115_request_diff_AIN0_AIN3() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN0_AIN3); };
static inline esp_err_t ADS1115_request_diff_AIN1_AIN3() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN1_AIN3); };
static inline esp_err_t ADS1115_request_diff_AIN2_AIN3() { return ADS1115_request_by_definition(ADS1115_CFG_MS_MUX_AIN2_AIN3); };
